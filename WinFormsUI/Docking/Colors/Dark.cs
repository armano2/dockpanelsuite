...
namespace WeifenLuo.WinFormsUI.Docking.Colors
{
    public class Dark : IColor
    {
        public Dark()
        {
            ...
            rgbTable[KnownColors.dragFrom] = Color.FromArgb(0xff, 91, 173, 255);

            rgbTable[KnownColors.ToolWindowTabBorder] = Color.FromArgb(255, 63, 63, 70);
            rgbTable[KnownColors.ToolWindowActivedTabBorder] = Color.FromArgb(255, 30, 30, 30);

            rgbTable[KnownColors.SplitterControl_horizontalBrush] = Color.FromArgb(0xFF, 37, 37, 38);
            rgbTable[KnownColors.SplitterControl_horizontalColor] = Color.FromArgb(255, 37, 37, 38);
            rgbTable[KnownColors.SplitterControl_verticalSurroundColors] = Color.FromArgb(255, 45, 45, 48);
        }
    }
}
